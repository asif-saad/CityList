...
public class MainActivityTest {
    ...
    public void ItemClickTest()
    {
        ...
        onView(withId(R.id.button_add)).perform(click());
        onView(withId(R.id.editText_name)).perform(ViewActions.typeText("Amsterdam"));
        Espresso.pressBack();
        onView(withId(R.id.button_confirm)).perform(click());


        onView(withId(R.id.button_add)).perform(click());
        onView(withId(R.id.editText_name)).perform(ViewActions.typeText("Kiev"));
        Espresso.pressBack();
        onView(withId(R.id.button_confirm)).perform(click());
        onView(withId(R.id.button_add)).perform(click());
        ...
        onView(withId(R.id.second)).check(matches(isDisplayed()));
        onView(withText("Berlin")).check(matches(isDisplayed()));
        onView(withId(R.id.button)).perform(click());
        onView(withId(R.id.main)).check(matches(isDisplayed()));
    }
